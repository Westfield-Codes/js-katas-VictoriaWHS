...
if (pettype == "Dog" || "dog") alert("I like dogs but they keep stealing from the mysterious bone pile ");
// if it is a cat, say "I'm allergic to cats"
else if (pettype == "Cat" || "cat") alert("I'm allergic but they keep breaking into my house and eatting all the mice");
// If it is not a dog or a cat, say "what an interesting pet!"
else alert("wow cool! I heard thoose could learn human language!");
alert("This one doesnt work and I dont know why");