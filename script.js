...
alert("You have a " + pettype + " nammed " + petname);
// if pet is a dog, say "I like dogs, too!"
if (pettype == "Dog" || "dog") alert("I like dogs but they keep stealing bones from the mysterious bone pit");
// if it is a cat, say "I'm allergic to cats"
else if (pettype == "Cat" || "cat") alert("I'm allergic but they keep breaking into my house.  But on the bright side no more mice!");
// If it is not a dog or a cat, say "what an interesting pet!"
else alert("wow cool!  I heard those things can actually speak human language!");